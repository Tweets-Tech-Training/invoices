...
{{--                                    <button type="button" class="btn btn-outline-primary waves-effect waves-light"  wire:click="create">اضافة العملة جديدة </button>--}}
    ...
    <div class="modal" id="DeleteCoinModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">حذف العملة </h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" id="SubmitDeleteCityForm">نعم </button>
                    <button type="button" class="btn btn-default" data-target="#DeleteCityModal" id="getDeleteId" data-dismiss="modal">لا</button>
                </div>
            </div>
        </div>
    </div>
